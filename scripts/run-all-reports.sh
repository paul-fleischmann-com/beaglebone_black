...
report 7a-testing        go-tests-with-coverage python-tests c-coverage sonarqube-report sonarcloud-scan strictdoc-coverage-gate traceability-check
report 7b-analysis       python-security shellcheck
report 7c-docs           adoc-build strictdoc-export prepare-reports upload print-url
